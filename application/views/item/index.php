...
<!--    <script>
        $("btncheckout").click(function (e){
            var flag = 0;
            $(".fancy-checkbox-primary-custom-icons").each(function (){
                if($(this).val() != ""){
                    flag = 1;
                }
            });
            ...
            <div class="col-md col-md-offset-0" style="width: 1200px">
                ...
                <div class="panel panel-default panel-table">
                    ...
                    <div class="panel-body">
                        <table class="table table-bordered table-list">
                            ...
                            <tr>
                                <td align="center" width="14%">
                                    ...
                                    <a class="btn btn-default " href="<?= base_url("item/edit/{$data['id']}") ?>"><em
                                                class="glyphicon glyphicon-pencil"></em></a>
                                    <a onclick="return confirm('Anda yakin akan menghapus data <?= $data['nama'] ?>')"
                                       class="btn btn-danger" href="<?= base_url("item/hapus/{$data['id']}") ?>"><em
                        ...
                        <button type="submit" class="btn-lg btn-primary pull-right" id="btncheckout" href="<?= base_url('transaksi/pesan') ?>">Pesan</button>
