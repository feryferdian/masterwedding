...
<div class="bride-grids">
	 <div class="container">
		 <div class="col-md-4 bride-grid">
			 <div class="content-grid l-grids">
				 <figure class="effect-bubba">
						<img src="<?= BASE_ASSETS ?>/application/views/images/b1.jpg" alt=""/>
						<figcaption>
			 ...
			 <div class="content-grid l-grids">
				 <figure class="effect-bubba">
						<img src="<?= BASE_ASSETS ?>/application/views/images/b2.jpg" alt=""/>
						<figcaption>
							<h4>Nullam molestie </h4>
							<p>In sit amet sapien eros Integer in tincidunt labore et dolore magna aliqua</p>																
						</figcaption>			
		 ...
		 <div class="col-md-4 bride-grid">
				<div class="content-grid l-grids">
						<img src="<?= BASE_ASSETS ?>/application/views/images/brid.jpg" alt=""/>
		 ...
		 <div class="col-md-4 bride-grid">
			 <div class="content-grid l-grids">
				 <figure class="effect-bubba">
						<img src="<?= BASE_ASSETS ?>/application/views/images/b3.jpg" alt=""/>
						<figcaption>
							<h4>Nullam molestie </h4>
							<p>In sit amet sapien eros Integer in tincidunt labore et dolore magna aliqua</p>																
						</figcaption>			
			 ...
			 <div class="content-grid l-grids">
				 <figure class="effect-bubba">
						<img src="<?= BASE_ASSETS ?>/application/views/images/b4.jpg" alt=""/>
						<figcaption>
							<h4>Nullam molestie </h4>
							<p>In sit amet sapien eros Integer in tincidunt labore et dolore magna aliqua</p>																
						</figcaption>			
	 ...
	 <div class="container">
		 ...
		 <div class="feature-grids">
			 <div class="col-md-3 feature-grid jewel">
				 <a href="product"><img src="<?= BASE_ASSETS ?>/application/views/images/f1.jpg" alt=""/>
					 <div class="arrival-info">
						 <h4>Jewellerys #1</h4>
						 <p>Rp 2.500.000</p>
						 <span class="pric1"><del>Rp 4.000.000</del></span>
						 <span class="disc">[12% Off]</span>
					 </div>
					 <div class="viw">
						<a href="product"><span class="glyphicon glyphicon-eye-open" aria-hidden="true"></span>Quick View</a>
					 </div>
					 <div class="shrt">
						<a href="product"><span class="glyphicon glyphicon-star" aria-hidden="true"></span>Shortlist</a>
					 </div></a>
			 </div>
			 <div class="col-md-3 feature-grid">
				 <a href="product"><img src="<?= BASE_ASSETS ?>/application/views/images/f2.jpg" alt=""/>
					 <div class="arrival-info">
						 <h4>Jewellerys #1</h4>
						 <p>Rp 14.000.000</p>
						 <span class="pric1"><del>Rp 1.500.000</del></span>
			 ...
			 <div class="col-md-3 feature-grid jewel">
				 <a href="product"><img src="<?= BASE_ASSETS ?>/application/views/images/f3.jpg" alt=""/>
					 <div class="arrival-info">
						 <h4>Wedding Ceramic Pot </h4>
						 <p>Rp 250.000</p>
						 <span class="pric1"><del>Rp 400.000</del></span>
						 <span class="disc">[10% Off]</span>
					 </div>
					 <div class="viw">
						<a href="product"><span class="glyphicon glyphicon-eye-open" aria-hidden="true"></span>Quick View</a>
			 ...
			 <div class="col-md-3 feature-grid">
				 <a href="product"><img src="<?= BASE_ASSETS ?>/application/views/images/f4.jpg" alt=""/>
					 <div class="arrival-info">
						 <h4>Jewellerys #1</h4>
						 <p>Rp 2.500.000</p>
						 <span class="pric1"><del>Rp 4.000.000</del></span>
		 ...
		 <div class="feature-grids">
			 <div class="col-md-3 feature-grid jewel">
				 <a href="product"><img src="<?= BASE_ASSETS ?>/application/views/images/p7.jpg" alt=""/>
					 <div class="arrival-info">
						 <h4>Jewellerys #1</h4>
						 <p>Rp 2.500.000</p>
						 <span class="pric1"><del>Rp 4.000.000</del></span>
			 ...
			 <div class="col-md-3 feature-grid">
				 <a href="product"><img src="<?= BASE_ASSETS ?>/application/views/images/p11.jpg" alt=""/>
					 <div class="arrival-info">
						 <h4>Jewellerys #1</h4>
						 <p>Rp 2.500.000</p>
						 <span class="pric1"><del>Rp 4.000.000</del></span>
			 ...
			 <div class="col-md-3 feature-grid jewel">
				 <a href="product"><img src="<?= BASE_ASSETS ?>/application/views/images/p12.jpg" alt=""/>
					 <div class="arrival-info">
						 <h4>Jewellerys #1</h4>
						 <p>Rp 2.500.000</p>
						 <span class="pric1"><del>Rp 4.000.000</del></span>
...
<div class="arrivals">
	 <div class="container">	
		 ...
		 <div class="arrival-grids">			 
			 <ul id="flexiselDemo1">
				 <li>
					 <a href="product"><img src="<?= BASE_ASSETS ?>/application/views/images/a1.jpg" alt=""/>
					 <div class="arrival-info">
				 ...
				 <li>
					 <a href="product"><img src="<?= BASE_ASSETS ?>/application/views/images/a2.jpg" alt=""/>
						<div class="arrival-info">
						 <h4>Vogue4All White Net Gowns</h4>
						 <p>Rp 3.500.000</p>
						 <span class="pric1"><del>Rp 300.0000</del></span>
						 <span class="disc">[10% Off]</span>
					 </div>
					 <div class="viw">
						<a href="#"><span class="glyphicon glyphicon-eye-open" aria-hidden="true"></span>Quick View</a>
				 ...
				 <li>
					 <a href="product"><img src="<?= BASE_ASSETS ?>/application/views/images/a3.jpg" alt=""/>
						<div class="arrival-info">
						 <h4>Platinum Waist Coat Set Navy</h4>
						 <p>Rp 800.000</p>
						 <span class="pric1"><del>Rp 1.700.000</del></span>
				 ...
				 <li>
				    <a href="product"> <img src="<?= BASE_ASSETS ?>/application/views/images/a4.jpg" alt=""/>
						<div class="arrival-info">
						 <h4>La Fanatise White Net Gowns</h4>
						 <p>Rp 4.000.000</p>
						 <span class="pric1"><del>Rp 4.500.0000</del></span>
				...
				<script type="text/javascript" src="<?= BASE_ASSETS ?>/application/views/js/jquery.flexisel.js"></script>
		  </div>
	 </div>
</div>
<!---->
	 ...
	 <div class="container">
		 <div class="shpng-grids">
			 <div class="col-md-4 shpng-grid">
				 <h3>Free Shipping</h3>
				 <p>On Order Over Rp.1.000.000</p>
			 </div>
			 <div class="col-md-4 shpng-grid">
				 <h3>Order Return</h3>
