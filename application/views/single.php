...
<div class="single-sec">
	 <div class="container">
					 ...
					 <div class="flexslider">
							<ul class="slides">
								<li data-thumb="images/s11.jpeg">
									<img src="<?= BASE_ASSETS ?>/application/views/images/s11.jpeg" />
								</li>
								<li data-thumb="images/s22.jpeg">
									<img src="<?= BASE_ASSETS ?>/application/views/images/s22.jpeg" />
								</li>
								<li data-thumb="images/s33.jpeg">
									<img src="<?= BASE_ASSETS ?>/application/views/images/s33.jpeg" />
								</li>
								<li data-thumb="images/s44.jpeg">
									<img src="<?= BASE_ASSETS ?>/application/views/images/s44.jpeg" />
								</li>
							</ul>
						</div>
						<!-- FlexSlider -->
						  <script defer src="<?= BASE_ASSETS ?>/application/views/js/jquery.flexslider.js"></script>
		 ...
		 <div class="arrival-grids">			 
			 <ul id="flexiselDemo1">
				 <li>
					 <a href="product"><img src="<?= BASE_ASSETS ?>/application/views/images/p2.jpg" alt=""/>
				 ...
				 <li>
					 <a href="product"><img src="<?= BASE_ASSETS ?>/application/views/images/p3.jpg" alt=""/>
						<div class="arrival-info">
						 <h4>Jewellerys #1</h4>
						 <p>Rs 14000</p>
				 ...
				 <li>
					 <a href="product"><img src="<?= BASE_ASSETS ?>/application/views/images/p4.jpg" alt=""/>
						<div class="arrival-info">
						 <h4>Jewellerys #1</h4>
						 <p>Rs 4000</p>
				 ...
				 <li>
				    <a href="product"> <img src="<?= BASE_ASSETS ?>/application/views/images/p5.jpg" alt=""/>
						<div class="arrival-info">
						 <h4>Jewellerys #1</h4>
						 <p>Rs 18000</p>
